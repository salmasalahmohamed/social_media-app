        ...
        <div class="max-w-[768px] mx-auto h-full overflow-auto">
            <div class="px-4">
                ...
                <div class="group relative bg-white dark:bg-slate-950 dark:text-gray-100">
                    <img :src="coverImageSrc || user.cover_path || '/img/default.jpg'"
                    ...
                    <div class="flex">
                        <div
                            ...
                            <img :src="avatarImageSrc || user.avatar_path || '/img/default_avatar.jpg'"
            ...
            <div class="border-t m-4 mt-0">
                <TabGroup>
                    <TabList class="flex bg-white dark:bg-slate-950 dark:text-white">
                        ...
                        <Tab v-slot="{ selected }" as="template">
                            <TabItem title="Followers" :selected="selected"/>
                        </Tab>
                        <Tab v-slot="{ selected }" as="template">
                            <TabItem title="Followings" :selected="selected"/>
                        </Tab>

                        <Tab v-if="isMyProfile" v-slot="{ selected }" as="template">
                            <TabItem title="My Profile" :selected="selected"/>
                        </Tab>
                    </TabList>
